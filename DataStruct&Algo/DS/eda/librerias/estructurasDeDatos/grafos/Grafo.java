...
public abstract class Grafo { 
    ...
    /* diseña un método finDelDFS que, con coste mínimo, devuelva un array
    cuyos elementos sean los vértices del Grafo en el orden en el que finaliza su DFS.
    Consejo. No empezar el diseño de finDelDFS desde cero, sino modificar donde sea necesario el
    método toArrayDFS de la clase */
