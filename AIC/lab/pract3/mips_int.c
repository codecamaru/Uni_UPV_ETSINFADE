    ...
    switch (solucion_riesgos_datos) {
        case parada:
            /* Riesgo entre EX e ID */
               if (escribe_Rdst(ID_EX.IR) && (lee_Rfte1(IF_ID.IR) && (ID_EX.IR.Rdestino == IF_ID.IR.Rfuente1)) ||
		   (lee_Rfte2(IF_ID.IR) && (ID_EX.IR.Rdestino == IF_ID.IR.Rfuente2)))
		{
            ...
            /* Riesgo entre MEM e ID */
               if (escribe_Rdst(EX_MEM.IR) && ((lee_Rfte1(IF_ID.IR) && (EX_MEM.IR.Rdestino == IF_ID.IR.Rfuente1)) ||
        ...
        case cortocircuito:
            /* Riesgo entre LOAD en EX e ID */
             if (es_load(ID_EX.IR) && ((lee_Rfte1(IF_ID.IR) && (ID_EX.IR.Rdestino == IF_ID.IR.Rfuente1)) || (lee_Rfte2(IF_ID.IR) && (ID_EX.IR.Rdestino == IF_ID.IR.Rfuente2)))) {
                    IFstall=SI;
                    IDstall=SI;
            }
